...
const ArticleCard: React.FC<IArticleCard> = (post) => {
  ...
  return (
    <article
      key={post.id}
      className="flex flex-col justify-between  w-[350px] h-[200px] border rounded-md p-4 bg-[#eeeeee] border-gray-500"
    >
      ...
      <div className="flex justify-between items-start">
        ...
        <Link
          to={post.url}
          target="_blank"
          className="flex gap-4 justify-end items-end w-[100px]"
        >
